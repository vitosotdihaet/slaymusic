from dto.music import MusicStats, Track, Artist
...
class IMusicArtistRepository(Protocol):
    async def add(self, artist: Artist) -> None: ...
    async def get(self, name: str) -> Artist | None: ...
    async def update(self, name: str, artist: Artist) -> None: ...
    async def delete(self, name: str) -> None: ...
