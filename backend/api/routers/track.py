...
router = APIRouter(prefix="/music", tags=["track"])
...
async def create_single(
    ...
    try:
        return await music_service.create_music_single(
...
async def create_music(
    ...
    try:
        return await music_service.create_music_to_album(new_track, data, content_type)
...
async def stream_music_endpoint(
    ...
    try:
        music = await music_service.stream_music(track_id, start, end)
...
async def get_track(
    ...
    try:
        return await music_service.get_music_metadata(track_id)
    except TrackNotFoundException as e:
        raise HTTPException(status_code=status.HTTP_404_NOT_FOUND, detail=str(e))
...
async def get_track_by_album(
    ...
    try:
        return await music_service.get_musics_metadata_by_album(album_id, skip, limit)
...
async def get_track_by_artist(
    ...
    try:
        return await music_service.get_musics_metadata_by_artist(artist_id, skip, limit)
...
async def get_tracks(
    ...
    try:
        return await music_service.get_musics_metadata(skip, limit)
    except MusicBaseException as e:
        raise HTTPException(status_code=status.HTTP_404_NOT_FOUND, detail=str(e))
...
async def get_image(
    ...
    try:
        image_bytes = await music_service.get_music_image(track_id)
...
async def update_metadata(
    ...
    try:
        return await music_service.update_music_metadata(track)
    except (
        AlbumNotFoundException,
        ArtistNotFoundException,
        TrackNotFoundException,
...
async def update_image(
    ...
    try:
        return await music_service.update_music_file(
...
@router.put("/track/", status_code=status.HTTP_200_OK)
async def update_track(
    track_id: TrackID = Depends(),
    music_file: UploadFile = File(),
    music_service: MusicService = Depends(get_music_service),
):
    cover_bytes = await music_file.read()
    cover_content_type = music_file.content_type
...
async def delete_track(
    ...
    try:
        await music_service.delete_music(track_id)
    except TrackNotFoundException as e:
        raise HTTPException(status_code=status.HTTP_404_NOT_FOUND, detail=str(e))
...
async def delete_track_image(
    ...
    try:
        await music_service.delete_music_image(track_id)
    except (TrackNotFoundException, ImageFileNotFoundException) as e:
        raise HTTPException(status_code=status.HTTP_404_NOT_FOUND, detail=str(e))
